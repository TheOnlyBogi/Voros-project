...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Már 10. 18:43
...
CREATE TABLE `categories` (
  ...
  `madar_termek_id` int(255) NOT NULL,
...
--
-- A tábla adatainak kiíratása `hal_hullo_termek`
--
...
--
-- A tábla adatainak kiíratása `hullő_termek`
--

INSERT INTO `hullő_termek` (`id`, `nev`, `ar`, `leiras`, `kepek_id`) VALUES
(1, 'Hüllő hőmérő', 1500, 'Precíz és könnyen olvasható hőmérő hüllők terráriumához, amely segít a megfelelő hőmérséklet fenntartásában.', 0),
(2, 'Hüllő táplálótál', 800, 'Könnyen tisztítható és tartós műanyag táplálótál hüllők számára, amely segíti a rendszeres és tiszta táplálkozást.', 0),
(3, 'Hüllő csontváz dísz', 2000, 'Valósághű és különleges csontváz dísz hüllő terráriumokhoz, amelyek érdekesebbé teszik a terrárium belső kialakítását.', 0),
(4, 'Hüllő napfénylámpa', 2500, 'UVB-sugárzó napfénylámpa hüllők terráriumához, amely segíti azokat a D-vitamin termelésében és az anyagcserében.', 0),
(5, 'Hüllő hidegoldó', 1200, 'Elektromos hidegoldó hüllők terráriumához, amely segít megakadályozni a túlzott hőmérsékletet a terráriumban.', 0),
(6, 'Hüllő szőnyeg', 600, 'Természetes hatású és könnyen tisztítható szőnyeg hüllők terráriumához, amely segíti a hüllők mozgását és kényelmét.', 0),
(7, 'Hüllő terrárium dísz', 1800, 'Természetes megjelenésű műanyag dísz hüllő terráriumokhoz, hogy valósághűbbé tegye a környezetüket.', 0),
(8, 'Hüllő lámpa állvány', 2000, 'Állítható hő- és fényforrás tartó állvány hüllők terráriumához, hogy megfelelő környezetet biztosítson számukra.', 0),
(9, 'Hüllő terrárium növény', 1200, 'Természetes megjelenésű műanyag növény hüllő terráriumokhoz, hogy otthonosabbá tegye a hüllők élőhelyét.', 0);
...
--
-- A tábla adatainak kiíratása `kisemlos_termek`
--
...
--
-- A tábla adatainak kiíratása `kutya_termek`
--
...
--
-- A tábla adatainak kiíratása `macska_termek`
--
...
--
-- A tábla adatainak kiíratása `madar_termek`
--
...
ALTER TABLE `categories`
  ...
  ADD CONSTRAINT `categories_ibfk_8` FOREIGN KEY (`madar_termek_id`) REFERENCES `madar_termek` (`id`),
  ADD CONSTRAINT `categories_ibfk_9` FOREIGN KEY (`kategoria_id`) REFERENCES `termekek` (`kategoria_id`);
...
--
ALTER TABLE `kepek`
  ADD CONSTRAINT `kepek_ibfk_1` FOREIGN KEY (`kepek_id`) REFERENCES `kisemlos_termek` (`kepek_id`);
...
ALTER TABLE `kosar`
  ...
  ADD CONSTRAINT `kosar_ibfk_2` FOREIGN KEY (`megrendeles_id`) REFERENCES `megrendeles` (`megrendeles_id`);
...
--
-- Megkötések a táblához `megrendelő`
--
ALTER TABLE `megrendelő`
  ADD CONSTRAINT `megrendelő_ibfk_1` FOREIGN KEY (`megrendelő_id`) REFERENCES `megrendeles` (`megrendelő_id`);
COMMIT;
