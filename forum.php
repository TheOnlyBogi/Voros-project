...
<body>
  ...
  <script>
    ...
    <div id="containerforum" style="border: double 2px rgb(255, 255, 255);">
        <div id="chatbox"></div>
        <div id="input-box">
            <input type="text" id="name" placeholder="Név">
            <input type="text" id="message" placeholder="Üzenet">
            <button onclick="sendMessage()" style="background-color: #3596a7;">Küldés</button>
        </div>
    </div>
    ...
    <script>
        ...
        function sendMessage() {
            ...
            newMessage.innerHTML = '<div class="meta">' + currentTime + ' - <span class="name">' + name + ':</span></div><div class="content">' + message + '</div>';
            chatbox.insertBefore(newMessage, chatbox.firstChild); // Az új üzeneteket az elejére rakja
            document.getElementById("name").value = ""; 
            document.getElementById("message").value = ""; 
            chatbox.scrollTop = 0; // Az elejére görgetjük a chat ablakot
        }
    </script>
